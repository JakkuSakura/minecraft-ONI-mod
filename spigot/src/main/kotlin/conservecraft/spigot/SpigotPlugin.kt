...
import conservecraft.spigot.world.OniChunkGenerator
...
class SpigotPlugin : JavaPlugin() {
    override fun onEnable() {
        ...
        Bukkit.getLogger().info(ChatColor.GREEN.toString() + "Enabled ConserveCraft")
    }

    override fun onDisable() {
        instance = null
        Bukkit.getLogger().info(ChatColor.RED.toString() + "Disabled ConserveCraft")
    }
