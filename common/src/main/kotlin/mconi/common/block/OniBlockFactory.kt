...
object OniBlockFactory {
    ...
    fun blockDigYield(entity: mconi.common.block.entity.OniElementBlockEntity): Int {
    ...
    fun blockDigYield(level: net.minecraft.server.level.ServerLevel, pos: net.minecraft.core.BlockPos): Int {
        val entity = level.getBlockEntity(pos) as? mconi.common.block.entity.OniElementBlockEntity ?: return 0
