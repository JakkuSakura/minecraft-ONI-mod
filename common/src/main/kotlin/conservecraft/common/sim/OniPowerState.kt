...
class OniPowerState {
    ...
    private var networks: List<conservecraft.common.sim.power.OniPowerNetwork> = emptyList()
    ...
    fun networks(): List<conservecraft.common.sim.power.OniPowerNetwork> = networks
    ...
    fun setNetworks(next: List<conservecraft.common.sim.power.OniPowerNetwork>) {
